...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "nexus~kz9y0JgS#JxxqDbEtlDjXViUdx8FDHhwUqBkLRcChlqCosbTBarc",
// add your Session Id 
...
STICKER_NAME: process.env.STICKER_NAME || "SANJU-MD",
...
// add bot owner name
DESCRIPTION: process.env.DESCRIPTION || "*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ YAMRAJ*",
// add bot owner name    
...
DEV: process.env.DEV || "9728893187",
